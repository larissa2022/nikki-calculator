...
| [验收清单模板](ai/templates/验收清单模板.md) / 本地验收包 `tmp/验收清单.md` | 统一生成当前 Preview 人工验收的账号模块、简单密码、数据、最短步骤与预期结果；按 [`WORKFLOWS.md`](ai/WORKFLOWS.md#62-验收包) 执行 | 仓库事实、长期密码存储、自动生效的发布许可 |
