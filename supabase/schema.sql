...
-- DB-6: 20260725151136_db6_create_re_review_items (verified on development and local replay)
begin;
...
-- DB-6 patch: 20260726022216_db6_restrict_candidate_insert_columns (verified on development and local replay)
begin;
...
-- DB-7 snapshot additions; source of truth remains the migrations below.
begin;
