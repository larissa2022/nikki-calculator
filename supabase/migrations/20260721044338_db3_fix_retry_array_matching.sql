...
-- Patch DB-3 after development verification found that schema-qualified
-- multi-array unnest is unavailable. Keep the applied migration immutable and
-- use array subscripts for exact retry fact matching instead.
